      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
        <div className="md:col-span-5 z-10 fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button className="bg-primary hover:bg-accent text-primary-foreground px-8 py-6 rounded-none text-xs uppercase tracking-widest transition-all duration-300 h-14">
              Shop New Drop
            </Button>
            <Button variant="ghost" className="text-primary hover:bg-secondary/20 px-8 py-6 rounded-none text-xs uppercase tracking-widest transition-all duration-300 h-14">
              Our Vision
            </Button>
          </div>
        </div>
        ...
        <div className="md:col-span-7 relative h-[600px] md:h-[800px] w-full fade-in" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="relative h-full w-full overflow-hidden shadow-2xl">
            <Image
              src={heroImage?.imageUrl || "https://picsum.photos/seed/versare-street/1200/800"}

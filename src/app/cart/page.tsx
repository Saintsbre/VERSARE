  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <div className="pt-32 pb-20 px-6 md:px-12 max-w-7xl mx-auto">
        <h1 className="text-4xl font-headline text-primary mb-12">Your Shopping Bag</h1>
        ...
        {cart.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 gap-6 fade-in">
            ...
            <p className="text-primary/60 font-body text-lg italic">Your bag is currently empty.</p>
            <Link href="/">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
            ...
            <div className="lg:col-span-4 fade-in" style={{ animationDelay: '0.2s' }}>
              <div className="bg-white/40 p-8 shadow-sm">
                <h2 className="text-xl font-headline text-primary mb-8 pb-4 border-b border-primary/10">Order Summary</h2>
